...
function HeadSVG({ stage, selected }: { stage: number; selected: boolean }) {
  ...
  return (
    <svg viewBox="0 0 60 74" width="64" height="80" fill="none">
      ...
      <g clipPath={`url(#${cid})`}>
        {stage === 1 && <rect x="0" y="0" width="60" height="40" fill={HR_BASE} />}
        {stage === 2 && (<><rect x="0" y="0" width="60" height="40" fill={HR_BASE} /><ellipse cx="13" cy="40" rx="8" ry="7.5" fill={sk} /><ellipse cx="47" cy="40" rx="8" ry="7.5" fill={sk} /></>)}
        {stage === 3 && (<><rect x="0" y="0" width="60" height="38" fill={HR_BASE} /><ellipse cx="12" cy="38" rx="12" ry="11" fill={sk} /><ellipse cx="48" cy="38" rx="12" ry="11" fill={sk} /></>)}
        {stage === 4 && (<><rect x="0" y="0" width="60" height="36" fill={HR_BASE} /><ellipse cx="11" cy="36" rx="15" ry="14" fill={sk} /><ellipse cx="49" cy="36" rx="15" ry="14" fill={sk} /><ellipse cx="30" cy="22" rx="10" ry="9" fill={sk} /></>)}
        {stage === 5 && (<><ellipse cx="30" cy="43" rx="22" ry="27" fill={sk} /><ellipse cx="9" cy="46" rx="9" ry="20" fill={HR_BASE} /><ellipse cx="51" cy="46" rx="9" ry="20" fill={HR_BASE} /><ellipse cx="30" cy="67" rx="20" ry="7" fill={HR_BASE} /></>)}
      </g>
...
function FaceSVG({ stage, selected }: { stage: number; selected: boolean }) {
  ...
  return (
    <svg viewBox="0 0 60 74" width="64" height="80" fill="none">
      <defs><clipPath id={`fc-s${stage}-${selected ? "a" : "b"}`}><ellipse cx="30" cy="43" rx="22" ry="27" /></clipPath></defs>
      <ellipse cx="7"  cy="45" rx="4"  ry="5.5" fill={ear} />
      <ellipse cx="53" cy="45" rx="4"  ry="5.5" fill={ear} />
      <ellipse cx="30" cy="43" rx="22" ry="27"  fill={sk}  />
      ...
      {stage === 2 && (<><circle cx="24" cy="38" r="1.6" fill={s1} /><circle cx="36" cy="41" r="1.4" fill={s2} /><circle cx="28" cy="48" r="1.3" fill={s1} /><circle cx="34" cy="35" r="1.2" fill={s2} /></>)}
      {stage === 3 && (<><ellipse cx="21" cy="44" rx="7" ry="5" fill={pig} /><circle cx="24" cy="36" r="1.8" fill={s1} /><circle cx="37" cy="39" r="1.6" fill={s2} /><circle cx="28" cy="46" r="1.5" fill={s1} /><circle cx="33" cy="43" r="1.4" fill={s2} /><circle cx="22" cy="50" r="1.3" fill={s1} /><circle cx="38" cy="48" r="1.4" fill={s2} /><circle cx="30" cy="54" r="1.2" fill={s1} /></>)}
      {stage === 4 && (<><ellipse cx="19" cy="43" rx="8" ry="6" fill={pig} /><ellipse cx="41" cy="43" rx="7" ry="5.5" fill={pig} /><circle cx="22" cy="36" r="2.0" fill={s1} /><circle cx="28" cy="33" r="1.8" fill={s2} /><circle cx="36" cy="37" r="1.9" fill={s1} /><circle cx="25" cy="44" r="1.7" fill={s2} /><circle cx="33" cy="41" r="1.6" fill={s1} /><circle cx="20" cy="49" r="1.5" fill={s2} /><circle cx="38" cy="47" r="1.6" fill={s1} /><circle cx="30" cy="52" r="1.4" fill={s2} /><circle cx="27" cy="57" r="1.2" fill={s1} /></>)}
      {stage === 5 && (<><ellipse cx="19" cy="41" rx="10" ry="8" fill={pig} /><ellipse cx="41" cy="42" rx="10" ry="8" fill={pig} /><ellipse cx="30" cy="54" rx="12" ry="7" fill={pig} /><circle cx="22" cy="34" r="2.3" fill={s1} /><circle cx="30" cy="31" r="2.0" fill={s2} /><circle cx="38" cy="35" r="2.2" fill={s1} /><circle cx="19" cy="42" r="2.0" fill={s2} /><circle cx="27" cy="40" r="1.9" fill={s1} /><circle cx="35" cy="39" r="2.0" fill={s2} /><circle cx="41" cy="44" r="1.9" fill={s1} /><circle cx="23" cy="50" r="1.8" fill={s2} /><circle cx="31" cy="48" r="1.8" fill={s1} /><circle cx="38" cy="52" r="1.7" fill={s2} /><circle cx="26" cy="57" r="1.5" fill={s1} /><circle cx="34" cy="58" r="1.4" fill={s2} /></>)}
      <ellipse cx="30" cy="54" rx="13" ry="11" fill="rgba(0,0,0,0.04)" />
    </svg>
  );
}
...
/* ═══════════════════════════════════════════════════
   STAGE CARD — dark glass
═══════════════════════════════════════════════════ */
function StageCard({
  stage, label, desc, selected, onClick, category,
}: {
  stage: number; label: string; desc: string;
  ...
  return (
    <button
      ...
      style={{
        ...
        position: "relative",
        background: selected
          ? (isHair ? "rgba(94,154,113,0.3)" : "rgba(200,107,155,0.3)")
          : hov
        ...
        transform: selected ? "translateY(-8px) scale(1.03)" : hov ? "translateY(-4px)" : "none",
        boxShadow: selected
    ...
    >
      ...
      {/* Stage image */}
      <div className="stage-card-img" style={{
        width: "112px",
        height: "104px",
        borderRadius: "20px",
        overflow: "hidden",
        ...
        filter: selected
          ? `drop-shadow(0 0 14px ${glowColor}) drop-shadow(0 4px 8px rgba(0,0,0,0.4))`
          : hov
            ? "drop-shadow(0 4px 10px rgba(0,0,0,0.35))"
            : "drop-shadow(0 3px 6px rgba(0,0,0,0.3))",
        transition: "filter 0.25s, border-color 0.25s, transform 0.25s",
        transform: selected ? "scale(1.04)" : "scale(1)",
        background: "linear-gradient(135deg, rgba(255,253,250,0.14), rgba(255,253,250,0.04))",
      }}>
        <img
          src={imageSrc}
          alt={`${category === "hair" ? "Hair loss" : "Skin concern"} ${label}`}
          style={{
            width: "100%",
            height: "100%",
            objectFit: "contain",
            ...
            display: "block",
            filter: selected || hov ? "brightness(1.03) saturate(1.08)" : "none",
      ...
      <p style={{
        ...
        color: selected ? accent : hov ? "rgba(255,253,250,0.9)" : "rgba(255,253,250,0.65)",
...
function BookingPopup({ info, onClose }: { info: PopupInfo; onClose: () => void }) {
  ...
  const inputStyle: React.CSSProperties = {
    width: "100%", border: `1px solid ${isHair ? "rgba(94,154,113,0.25)" : "rgba(200,107,155,0.25)"}`,
    background: "rgba(255,253,250,0.05)", padding: "13px 15px",
    fontSize: "var(--fs-body)", color: "#fffdfa", outline: "none",
  ...
  return (
    <div onClick={onClose} style={{
      ...
      background: "rgba(14,9,12,0.75)", backdropFilter: "blur(6px)",
      display: "flex", alignItems: "center", justifyContent: "center",
      ...
      <div onClick={e => e.stopPropagation()} style={{
        ...
        <div style={{ position: "relative", zIndex: 1, padding: "20px 22px 16px" }}>
          <div style={{
            ...
            <span style={{ width: "5px", height: "5px", background: accent, borderRadius: "50%", display: "inline-block" }}/>
            {info.category === "hair" ? "Hair Loss" : "Skin Concern"} — Stage {info.stage}
          </div>
          <h3 style={{ margin: "0 0 6px 0", fontSize: "var(--fs-subtitle)", fontWeight: 900, color: "#fffdfa", lineHeight: 1.2 }}>
            Book Your Consultation
          </h3>
          <p style={{ margin: 0, fontSize: "var(--fs-small)", color: "rgba(255,253,250,0.5)", lineHeight: 1.55 }}>
            {info.desc} — our specialist will reach out shortly.
          </p>
        </div>

        {/* divider */}
        <div style={{ height: "1px", background: `linear-gradient(90deg, transparent, ${accent}44, transparent)`, margin: "0 22px" }} />

        {/* form */}
        <div style={{ position: "relative", zIndex: 1, padding: "18px 22px 22px", display: "flex", flexDirection: "column", gap: "12px" }}>
          {[
          ...
          <a
            ...
            style={{
              ...
              fontSize: "var(--fs-eyebrow)", fontWeight: 700, letterSpacing: "0.14em",
          ...
          <p style={{ margin: 0, fontSize: "var(--fs-eyebrow)", color: "rgba(255,253,250,0.28)", textAlign: "center", lineHeight: 1.5 }}>
...
export default function HairLossStage() {
  ...
  const tickProgress = useCallback(() => {
    const pct = Math.min(((Date.now() - startRef.current) / TAB_INTERVAL) * 100, 100);
    setProgress(pct);
    if (pct < 100) rafRef.current = requestAnimationFrame(tickProgress);
  }, []);

  const switchTo = useCallback((cat: "hair" | "skin") => {
    setCategory(cat); setSelected(null); setProgress(0);
  ...
  const progBg   = category === "hair"
    ? `linear-gradient(90deg, ${SAGE_DEEP}, ${SAGE}, #8bbf97)`
    : `linear-gradient(90deg, ${ROSE_DEEP}, ${ROSE}, #d9a0be)`;
  const glowColor= category === "hair" ? "rgba(94,154,113,0.3)" : "rgba(200,107,155,0.3)";
    ...
    <>
      <section style={{
        ...
        <div aria-hidden style={{
          ...
          background: "radial-gradient(ellipse, rgba(94,154,113,0.2) 0%, transparent 65%)",
        ...
        <div aria-hidden style={{
          ...
          background: "radial-gradient(ellipse, rgba(200,107,155,0.2) 0%, transparent 65%)",
          zIndex: 2, pointerEvents: "none",
        }} />
        ...
        {/* ── inner ── */}
        <div className="stage-inner" style={{ position: "relative", zIndex: 10, maxWidth: "960px", margin: "0 auto", padding: "0 36px" }}>

          {/* ── HEADING ── */}
          <div style={{ marginBottom: "36px", textAlign: "center" }}>
            <div style={{ display: "inline-flex", alignItems: "center", gap: "8px", marginBottom: "12px" }}>
              <span style={{ display: "block", width: "36px", height: "1.5px", background: "#c86b9b" }} />
              <span style={{ fontSize: "var(--fs-eyebrow)", letterSpacing: "0.28em", textTransform: "uppercase", color: "#c86b9b", fontWeight: 700 }}>
                Self Diagnosis
              </span>
              <span style={{ display: "block", width: "36px", height: "1.5px", background: "#c86b9b" }} />
            </div>
            <h2 style={{
              ...
              Find Your Stage,<br />Start Your Transformation
            </h2>
            <p style={{ fontSize: "var(--fs-body)", color: "rgba(255,253,250,0.48)", margin: "0 auto", maxWidth: "460px", lineHeight: 1.65 }}>
              Select your hair loss or skin concern stage — get a personalised treatment recommendation instantly.
            </p>
          </div>
          ...
          {selected !== null && (
            <div style={{
              ...
              <div style={{
                ...
                <svg width="12" height="12" viewBox="0 0 12 12" fill="none">
                  <path d="M6 2v4l2.5 2.5" stroke="#fff" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"/>
                  <circle cx="6" cy="6" r="5" stroke="#fff" strokeWidth="1.5"/>
                </svg>
              </div>
              <div>
                <p style={{ margin: "0 0 4px 0", fontSize: "var(--fs-small)", fontWeight: 800, color: accent, letterSpacing: "0.06em", textTransform: "uppercase" }}>
                  Stage {selected} — {stages[selected - 1].desc}
                </p>
                <p style={{ margin: 0, fontSize: "var(--fs-small)", color: "rgba(255,253,250,0.65)", lineHeight: 1.65 }}>
                  {hints[selected]}
                </p>
              </div>
            </div>
          ...
          {/* caption */}
          <p style={{
            textAlign: "center", margin: "16px 0 0 0",
            fontSize: "11px", color: "rgba(255,253,250,0.22)",
      ...
      {popup !== null && (
        <BookingPopup
          info={popup}
          onClose={() => { setPopup(null); setSelected(null); }}
        />
      )}
